...
fun testSubscribeNewsletterBpmnModel(
    ...
    flowNodes: List<FlowNodeDefinition> = listOf(
        FlowNodeDefinition("CallActivity_AbortRegistration", BpmnElementType.CALL_ACTIVITY,
            ...
            incoming = listOf("Timer_After3Days"), outgoing = listOf("CompensationEndEvent_RegistrationAborted")),
        ...
        FlowNodeDefinition("serviceTask_incrementSubscriptionCounter", BpmnElementType.SERVICE_TASK,
            ...
            incoming = listOf("StartEvent_SubmitRegistrationForm"), outgoing = listOf("SubProcess_Confirmation")),
        ...
        FlowNodeDefinition("SubProcess_Confirmation", BpmnElementType.SUB_PROCESS,
            ...
            incoming = listOf("serviceTask_incrementSubscriptionCounter"), outgoing = listOf("Activity_SendWelcomeMail")),
...
fun testSendNewsletterBpmnModel(
    ...
    flowNodes: List<FlowNodeDefinition> = listOf(
        ...
        FlowNodeDefinition("serviceTask_loadSubscribers", BpmnElementType.SERVICE_TASK,
            ...
            variables = listOf(VariableDefinition("subscribers"), VariableDefinition("author")),
            incoming = listOf("startEvent_editionCreated"), outgoing = listOf("gateway_hasSubscribers")),
        FlowNodeDefinition("gateway_hasSubscribers", BpmnElementType.EXCLUSIVE_GATEWAY,
            incoming = listOf("serviceTask_loadSubscribers"), outgoing = listOf("serviceTask_sendToSubscriber", "endEvent_noSubscribers")),
        FlowNodeDefinition("serviceTask_sendToSubscriber", BpmnElementType.SERVICE_TASK,
            ...
            incoming = listOf("gateway_hasSubscribers"), outgoing = listOf("serviceTask_notifyAuthor")),
        FlowNodeDefinition("serviceTask_notifyAuthor", BpmnElementType.SERVICE_TASK,
            ...
            incoming = listOf("serviceTask_sendToSubscriber"), outgoing = listOf("endEvent_editionSent")),
        ...
        FlowNodeDefinition("serviceTask_analyzeError", BpmnElementType.SERVICE_TASK,
            ...
            parentId = "eventSubProcess_errorHandling",
            incoming = listOf("event_mailRejected"), outgoing = listOf("gateway_canSendAgain")),
        FlowNodeDefinition("gateway_canSendAgain", BpmnElementType.EXCLUSIVE_GATEWAY,
            parentId = "eventSubProcess_errorHandling",
            incoming = listOf("serviceTask_analyzeError"), outgoing = listOf("serviceTask_sendMailAgain", "escalationEndEvent_nofitySupport")),
        FlowNodeDefinition("serviceTask_sendMailAgain", BpmnElementType.SERVICE_TASK,
            ...
            parentId = "eventSubProcess_errorHandling",
            incoming = listOf("gateway_canSendAgain"), outgoing = listOf("eventGateway_afterSendingAgain")),
        FlowNodeDefinition("eventGateway_afterSendingAgain", BpmnElementType.EVENT_BASED_GATEWAY,
            parentId = "eventSubProcess_errorHandling",
            incoming = listOf("serviceTask_sendMailAgain"), outgoing = listOf("timer_noRejectionForOneDay", "event_mailRejectedAgain")),
        FlowNodeDefinition("timer_noRejectionForOneDay", BpmnElementType.INTERMEDIATE_CATCH_EVENT,
            ...
            parentId = "eventSubProcess_errorHandling",
            incoming = listOf("eventGateway_afterSendingAgain"), outgoing = listOf("endEvent_issueResolved")),
        ...
        FlowNodeDefinition("event_mailRejectedAgain", BpmnElementType.INTERMEDIATE_CATCH_EVENT,
            parentId = "eventSubProcess_errorHandling",
            incoming = listOf("eventGateway_afterSendingAgain"), outgoing = listOf("escalationEndEvent_nofitySupportAfterRepeatedError")),
