...
```kotlin
version = "0.0.17"  // Increment version
```
...
3. Tags image as:
   - `emaarco/bpmn-to-code-web:VERSION` (e.g., `0.0.17`)
...
Expected output:
```
emaarco/bpmn-to-code-web   0.0.17    abc123def456   ...
...
```bash
docker push emaarco/bpmn-to-code-web:0.0.17
...
```bash
docker pull emaarco/bpmn-to-code-web:0.0.17
docker run -p 8080:8080 emaarco/bpmn-to-code-web:0.0.17
```
