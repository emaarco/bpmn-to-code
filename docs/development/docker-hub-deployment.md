...
```kotlin
version = "0.0.15"  // Increment version
```
...
Expected output:
```
emaarco/bpmn-to-code-web   0.0.15    abc123def456   ...
...
```bash
docker push emaarco/bpmn-to-code-web:0.0.15
...
```bash
docker pull emaarco/bpmn-to-code-web:0.0.15
docker run -p 8080:8080 emaarco/bpmn-to-code-web:0.0.15
```
