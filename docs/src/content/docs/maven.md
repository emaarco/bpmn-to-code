---
title: Maven Plugin
description: Generate Process APIs from BPMN files in your Maven builds.
---
...
For a full guide on filtering strategies, see [BPMN File Filtering](guides/filtering).
...
- [Gradle Plugin](gradle) — Gradle alternative
- [Web Application](web) — No build tool required
