---
title: Architecture
description: bpmn-to-code system design using hexagonal architecture with ports and adapters.
---
...
For detailed architecture decisions, see the [ADR section](adr/index).
